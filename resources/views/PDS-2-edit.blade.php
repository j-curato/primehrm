...
<nav aria-label="...">
  <ul class="pagination">
    ...
    <li class="page-item  <?php if($segment=='sheet1'){ echo 'active'; } ?>"><a class="page-link" href="{{ url('pds/sheet1') }}">Sheet 1</a></li>
    <li class="page-item <?php if($segment=='sheet2'){ echo 'active'; } ?>">
      <a class="page-link" href="{{ url('pds/sheet2') }}">Sheet 2<span class="sr-only">(current)</span></a>
    </li>
    <li class="page-item <?php if($segment=='sheet3'){ echo 'active'; } ?>"><a class="page-link" href="{{ url('pds/sheet3') }}">Sheet 3</a></li>
    <li class="page-item <?php if($segment=='sheet4'){ echo 'active'; } ?>"><a class="page-link" href="{{ url('pds/sheet4') }}">Sheet 4</a></li>
    <!-- <li class="page-item">
      <a class="page-link" href="#">Next</a>
    </li> -->
  </ul>
</nav>
<?php //var_dump($secIV[0]->emp_eligibility); ?>
<!--[if !excel]>&nbsp;&nbsp;<![endif]-->
...
<table border=0 cellpadding=0 cellspacing=0 width=889 class=xl655355850
 ...
 <tr height=36 style='mso-height-source:userset;height:27.0pt'>
  ...
  width:194pt'><input type="text" name="pds2[]" value="" style="height:30px; width:470px; border: none;border-color: transparent;"> </td>
  <td class=xl705850 width=90 style='border-left:none;width:68pt'><input type="text" name="pds2[]" value="" style="height:30px; width:145px; border: none;border-color: transparent;"></td>
  <td colspan=2 class=xl815850 width=96 style='border-left:none;width:72pt'><input type="date" name="pds2[]" value="" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td colspan=3 class=xl1095850 width=247 style='border-left:none;width:185pt'><input type="text" name="pds2[]" value="" style="height:30px; width:400px; border: none;border-color: transparent;"></td>
  <td class=xl705850 width=78 style='border-left:none;width:59pt'><input type="text" name="pds2[]" value="" style="height:30px; width:125px; border: none;border-color: transparent;"></td>
  <td class=xl835850 width=56 style='border-left:none;width:42pt'><input type="date" name="pds2[]" value="" style="height:30px; width:170px; border: none;border-color: transparent;"></td>
  <td class=xl655355850></td>
 </tr>
 ...
 <tr class=xl655355850 height=16 style='mso-height-source:userset;height:12.0pt'>
  ...
  height:12.0pt'>(Continue on separate sheet if necessary) </br><input type="submit" class="btn btn-success btn-submit-eligibility employee-tag" id="btn-submit-eligibility" value="Save Section IV"></td>
  <td class=xl655355850></td>
 </tr>
 </form>
 ...
 <tr class=xl695850 height=32 style='mso-height-source:userset;height:24.0pt'>
  ...
  height:24.0pt;width:50pt'><input type="date" name="pds2[]" value="" style="height:30px; width:130px; border: none;border-color: transparent;"></td>
  <td class=xl845850 width=68 style='border-top:none;border-left:none;
  width:51pt'><input type="date" name="pds2[]" value="" style="height:30px; width:130px; border: none;border-color: transparent;"></td>
  <td colspan=3 class=xl1245850 width=213 style='border-right:.5pt solid black;
  border-left:none;width:161pt; padding: 3px;'><input type="text" name="pds2[]" value="" style="height:30px; width:350px; border: none;border-color: transparent;"></td>
  <td colspan=3 class=xl1245850 width=219 style='border-right:.5pt solid black;
  border-left:none;width:164pt'><input type="text" name="pds2[]" value="" style="height:30px; width:358px; border: none;border-color: transparent;"></td>
  <td class=xl855850 align=right style='border-left:none'><input type="text" name="pds2[]" value="" style="height:30px; width:92px; border: none;border-color: transparent;"></td>
  <td class=xl865850 width=65 style='border-left:none;width:49pt'><input type="text" name="pds2[]" value="" style="height:30px; width:105px; border: none;border-color: transparent;"></td>
  <td class=xl875850 style='border-left:none'><input type="text" name="pds2[]" value="" style="height:30px; width:125px; border: none;border-color: transparent;"></td>
  <td class=xl885850 width=56 style='border-left:none;width:42pt'><input type="text" name="pds2[]" value="" style="height:30px; width:170px; border: none;border-color: transparent;"></td>
 ...
 <tr height=38 style='mso-height-source:userset;height:28.5pt'>
  ...
  <td class=xl825850 style='border-left:none'><input type="date" name="date_submitted_v" value="" style="height:30px; width:170px; border: none;border-color: transparent;"></td>
...
<button type="button" class="btn btn-success btn-submit-secV" >Save Section V</button>
</div>
