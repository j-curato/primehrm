...
<!--[if !mso]>
<style>
v\:* {behavior:url_view(#default#VML);}
o\:* {behavior:url_view(#default#VML);}
x\:* {behavior:url_view(#default#VML);}
.shape {behavior:url_view(#default#VML);}
</style>
<![endif]-->
<head>
...
" filled="f" stroked="f" o:insetmode="auto"/><![endif]-->Pls. indicate country:</td>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl1405155 style='border-top:none'>&nbsp;</td>
  <td colspan=3 class=xl2095155 style="padding: 3px;"><?php if(isset($employees[0]->emp_philhealth_number)){ echo $employees[0]->emp_philhealth_number; }else{ echo "N/A"; } ?></td>
  <td colspan=2 class=xl2035155 width=130 style='border-right:.5pt solid black;
  width:98pt'>ZIP CODE<span style='mso-spacerun:yes'>    </span></td>
  <td colspan=6 class=xl2265155 style='border-right:1.0pt solid black;
  border-left:none'><?php if(isset($employees[0]->perm_zipcode)){ echo $employees[0]->perm_zipcode; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl945155 style='height:15.0pt'>13.</td>
  <td class=xl1305155 style='border-top:none'>SSS NO.</td>
  <td class=xl1405155 style='border-top:none'>&nbsp;</td>
  <td colspan=3 class=xl2025155 style="padding: 3px;"><?php if(isset($employees[0]->emp_sss_number)){ echo $employees[0]->emp_sss_number; }else{ echo "N/A"; } ?></td>
  ...
  width:289pt'><?php if(isset($employees[0]->emp_tel_number)){ echo $employees[0]->emp_tel_number; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td colspan=3 height=20 class=xl2295155 style='height:15.0pt'>14. TIN NO.</td>
  <td colspan=3 class=xl2025155 style="padding:3px;"><?php if(isset($employees[0]->emp_tin_number)){ echo $employees[0]->emp_tin_number; }else{ echo "N/A"; } ?></td>
  <td class=xl2345155 colspan=2 style="background-color: #c0c0c0;">20. MOBILE NO.</td>
  <td colspan=6 class=xl2305155 width=383 style='border-right:1.0pt solid black;
  width:289pt'><?php if(isset($employees[0]->emp_mobile_number)){ echo $employees[0]->emp_mobile_number; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=21 style='height:15.75pt'>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  SURNAME</td>
  <td colspan=5 class=xl2465155 width=344 style='padding: 3px; border-left:none;width:258pt'><?php if(isset($employees[0]->emp_spouse_lname)){ echo $employees[0]->emp_spouse_lname; }else{ echo "N/A"; } ?></td>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl2205155>&nbsp;</td>
  <td colspan=3 class=xl2515155 width=214 style='padding: 3px; border-right:.5pt solid black; border-left:none;width:160pt'><?php if(isset($employees[0]->emp_spouse_fname)){ echo $employees[0]->emp_spouse_fname; }else{ echo "N/A"; } ?></td>
  <td colspan=2 class=xl2545155 width=130 style='padding: 3px; border-left:none;width:98pt'>NAME EXTENSION (JR., SR)<span style='mso-spacerun:yes'></span> <?php if(isset($employees[0]->emp_spouse_xname)){ echo $employees[0]->emp_spouse_xname; }else{ echo "N/A"; } ?></td>
  <td colspan=4 class=xl2525155 width=254 style='border-right:.5pt solid black;
  width:192pt'><?php if(isset($employees[0]->emp_child1)){ echo $employees[0]->emp_child1; }else{ echo "N/A"; } ?></td>
  <td colspan=2 class=xl2555155 width=129 style='border-right:1.0pt solid black; border-left:none;width:97pt'><?php if(isset($employees[0]->emp_child1_bdate)){ echo $employees[0]->emp_child1_bdate; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  ...
  <td colspan=5 class=xl2515155 width=344 style='padding: 3px; border-right:.5pt solid black;border-left:none;width:258pt'><?php if(isset($employees[0]->emp_spouse_mname)){ echo $employees[0]->emp_spouse_mname; }else{ echo "N/A"; } ?></td>
  <td colspan=4 class=xl2525155 width=254 style='border-right:.5pt solid black;width:192pt'><?php if(isset($employees[0]->emp_child2)){ echo $employees[0]->emp_child2; }else{ echo "N/A"; } ?></td>
  <td colspan=2 class=xl2555155 width=129 style='border-right:1.0pt solid black;
  border-left:none;width:97pt'><?php if(isset($employees[0]->emp_child2_bdate)){ echo $employees[0]->emp_child2_bdate; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl1405155 style='border-top:none'>&nbsp;</td>
  <td colspan=5 class=xl2615155 width=344 style='padding: 3px; border-left:none;width:258pt'><?php if(isset($employees[0]->emp_spouse_occupation)){ echo $employees[0]->emp_spouse_occupation; }else{ echo "N/A"; } ?></td>
  <td colspan=4 class=xl2525155 width=254 style='border-right:.5pt solid black;width:192pt'><?php if(isset($employees[0]->emp_child3)){ echo $employees[0]->emp_child3; }else{ echo "N/A"; } ?></td>
  <td colspan=2 class=xl2555155 width=129 style='border-right:1.0pt solid black;border-left:none;width:97pt'><?php if(isset($employees[0]->emp_child3_bdate)){ echo $employees[0]->emp_child3_bdate; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl2605155 style='height:15.0pt;border-top:none'>&nbsp;</td>
  <td class=xl1305155 colspan=2 style='border-right:.5pt solid black'>EMPLOYER/BUSINESS
  NAME</td>
  <td colspan=5 class=xl2615155 width=344 style='padding: 3px; border-left:none;width:258pt'><?php if(isset($employees[0]->emp_spouse_bn)){ echo $employees[0]->emp_spouse_bn; }else{ echo "N/A"; } ?></td>
  <td colspan=4 class=xl2525155 width=254 style='border-right:.5pt solid black;width:192pt'><?php if(isset($employees[0]->emp_child4)){ echo $employees[0]->emp_child4; }else{ echo "N/A"; } ?></td>
  <td colspan=2 class=xl2555155 width=129 style='border-right:1.0pt solid black;border-left:none;width:97pt'><?php if(isset($employees[0]->emp_child4_bdate)){ echo $employees[0]->emp_child4_bdate; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl2605155 style='height:15.0pt;border-top:none'>&nbsp;</td>
  <td class=xl1305155 colspan=2 style='border-right:.5pt solid black'>BUSINESS
  ADDRESS</td>
  <td colspan=5 class=xl2615155 width=344 style='padding: 3px; border-left:none;width:258pt'><?php if(isset($employees[0]->emp_spouse_bn_address)){ echo $employees[0]->emp_spouse_bn_address; }else{ echo "N/A"; } ?></td>
  <td colspan=4 class=xl2525155 width=254 style='border-right:.5pt solid black;width:192pt'><?php if(isset($employees[0]->emp_child5)){ echo $employees[0]->emp_child5; }else{ echo "N/A"; } ?></td>
  <td colspan=2 class=xl2555155 width=129 style='border-right:1.0pt solid black;border-left:none;width:97pt'><?php if(isset($employees[0]->emp_child5_bdate)){ echo $employees[0]->emp_child5_bdate; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  ...
  <td colspan=5 class=xl2615155 width=344 style='padding: 3px; border-left:none;width:258pt'><?php if(isset($employees[0]->emp_spouse_tel_no)){ echo $$employees[0]->emp_spouse_tel_no; }else{ echo "N/A"; } ?></td>
  <td colspan=4 class=xl2525155 width=254 style='border-right:.5pt solid black;width:192pt'><?php if(isset($employees[0]->emp_child6)){ echo $employees[0]->emp_child6; }else{ echo "N/A"; } ?></td>
  <td colspan=2 class=xl2555155 width=129 style='border-right:1.0pt solid black;border-left:none;width:97pt'><?php if(isset($employees[0]->emp_child6_bdate)){ echo $employees[0]->emp_child6_bdate; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl2635155 style='height:15.0pt'>24.</td>
  <td class=xl2645155>FATHER'S SURNAME</td>
  <td class=xl1515155>&nbsp;</td>
  <td colspan=5 class=xl2615155 width=344 style='width:258pt; padding:3px;'><?php if(isset($employees[0]->emp_father_lname)){ echo $employees[0]->emp_father_lname; }else{ echo "N/A"; } ?></td>
  <td colspan=4 class=xl2525155 width=254 style='border-right:.5pt solid black;width:192pt'><?php if(isset($employees[0]->emp_child7)){ echo $employees[0]->emp_child7; }else{ echo "N/A"; } ?></td>
  <td colspan=2 class=xl2555155 width=129 style='border-right:1.0pt solid black;border-left:none;width:97pt'><?php if(isset($employees[0]->emp_child7_bdate)){ echo $employees[0]->emp_child7_bdate; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl1245155 style='height:15.0pt'>&nbsp;</td>
  ...
  width:160pt'><?php if(isset($employees[0]->emp_father_fname)){ echo $employees[0]->emp_father_fname; }else{ echo "N/A"; } ?></td>
  <td colspan=2 class=xl2545155 width=130 style='padding: 3px;border-left:none;width:98pt'>NAME
  EXTENSION (JR., SR)<span
  style='mso-spacerun:yes'>                                     </span><?php if(isset($employees[0]->emp_father_xname)){ echo $employees[0]->emp_father_xname; }else{ echo "N/A"; } ?></td>
  <td colspan=4 class=xl2525155 width=254 style='border-right:.5pt solid black;
  width:192pt'><?php if(isset($employees[0]->emp_child8)){ echo $employees[0]->emp_child8; }else{ echo "N/A"; } ?></td>
  <td colspan=2 class=xl2555155 width=129 style='border-right:1.0pt solid black;
  border-left:none;width:97pt'><?php if(isset($employees[0]->emp_child8_bdate)){ echo $employees[0]->emp_child8_bdate; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl2575155 style='height:15.0pt'>&nbsp;</td>
  <td class=xl1935155>MIDDLE NAME</td>
  <td class=xl1935155>&nbsp;</td>
  <td colspan=5 class=xl2515155 width=344 style='padding: 3px; border-right:.5pt solid black;width:258pt'><?php if(isset($employees[0]->emp_father_mname)){ echo $employees[0]->emp_father_mname; }else{ echo "N/A"; } ?></td>
  <td colspan=4 class=xl2525155 width=254 style='border-right:.5pt solid black;width:192pt'><?php if(isset($employees[0]->emp_child9)){ echo $employees[0]->emp_child9; }else{ echo "N/A"; } ?></td>
  <td colspan=2 class=xl2555155 width=129 style='border-right:1.0pt solid black;border-left:none;width:97pt'><?php if(isset($employees[0]->emp_child9_bdate)){ echo $employees[0]->emp_child9_bdate; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  ...
  width:192pt'><?php if(isset($employees[0]->emp_child10)){ echo $employees[0]->emp_child10; }else{ echo "N/A"; } ?></td>
  <td colspan=2 class=xl2555155 width=129 style='border-right:1.0pt solid black;
  border-left:none;width:97pt'><?php if(isset($employees[0]->emp_child10_bdate)){ echo $employees[0]->emp_child10_bdate; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl1245155 style='height:15.0pt'>&nbsp;</td>
  <td class=xl995155>SURNAME</td>
  <td class=xl995155>&nbsp;</td>
  <td colspan=5 class=xl2655155 style="padding: 3px;"><?php if(isset($employees[0]->emp_mother_mlname)){ echo $employees[0]->emp_mother_mlname; }else{ echo "N/A"; } ?></td>
  <td colspan=4 class=xl2525155 width=254 style='border-right:.5pt solid black;width:192pt'><?php if(isset($employees[0]->emp_child11)){ echo $employees[0]->emp_child11; }else{ echo "N/A"; } ?></td>
  <td colspan=2 class=xl2555155 width=129 style='border-right:1.0pt solid black;border-left:none;width:97pt'><?php if(isset($employees[0]->emp_child11_bdate)){ echo $employees[0]->emp_child11_bdate; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl1245155 style='height:15.0pt'>&nbsp;</td>
  <td class=xl995155>FIRST NAME</td>
  <td class=xl995155>&nbsp;</td>
  <td colspan=5 class=xl2655155 style="padding: 3px;"><?php if(isset($employees[0]->emp_mother_mfname)){ echo $employees[0]->emp_mother_mfname; }else{ echo "N/A"; } ?></td>
  <td colspan=4 class=xl2525155 width=254 style='border-right:.5pt solid black;width:192pt'><?php if(isset($employees[0]->emp_child12)){ echo $employees[0]->emp_child12; }else{ echo "N/A"; } ?></td>
  <td colspan=2 class=xl2555155 width=129 style='border-right:1.0pt solid black;border-left:none;width:97pt'><?php if(isset($employees[0]->emp_child12_bdate)){ echo $employees[0]->emp_child12_bdate; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  <td height=21 class=xl2665155 style='height:15.75pt'>&nbsp;</td>
  <td class=xl1075155>MIDDLE NAME</td>
  <td class=xl1075155>&nbsp;</td>
  <td colspan=5 class=xl2675155 width=344 style='width:258pt; padding: 3px;'><?php if(isset($employees[0]->emp_mother_mmname)){ echo $employees[0]->emp_mother_mmname; }else{ echo "N/A"; } ?></td>
 ...
 <tr height=34 style='height:25.5pt'>
  ...
  <td colspan=3 class=xl2305155 width=214 style='border-right:.5pt solid black;width:160pt'><?php if(isset($employees[0]->emp_elem_school)){ echo $employees[0]->emp_elem_school; }else{ echo "N/A"; } ?></td>
  <td colspan=3 class=xl3055155 width=196 style='border-right:1.0pt solid black;border-left:none;width:148pt'><?php if(isset($employees[0]->emp_elem_degree)){ echo $employees[0]->emp_elem_degree; }else{ echo "N/A"; } ?></td>
  <td class=xl3085155 width=54 style='border-top:none;width:41pt'><?php if(isset($employees[0]->emp_elem_from)){ echo $employees[0]->emp_elem_from; }else{ echo "N/A"; } ?></td>
  <td class=xl3095155 width=54 style='border-top:none;width:41pt'><?php if(isset($employees[0]->emp_elem_to)){ echo $employees[0]->emp_elem_to; }else{ echo "N/A"; } ?></td>
  <td class=xl3105155 width=80 style='border-top:none;width:60pt'><?php if(isset($employees[0]->emp_elem_units)){ echo $employees[0]->emp_elem_units; }else{ echo "N/A"; } ?></td>
  <td class=xl3115155 width=62 style='border-top:none;border-left:none;width:47pt'><?php if(isset($employees[0]->emp_elem_yeargrad)){ echo $employees[0]->emp_elem_yeargrad; }else{ echo "N/A"; } ?></td>
  <td class=xl3125155 width=67 style='border-top:none;border-left:none;width:50pt'><?php if(isset($employees[0]->emp_elem_acadhonors)){ echo $employees[0]->emp_elem_acadhonors; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=34 style='height:25.5pt'>
  <td height=34 class=xl3025155 width=17 style='height:25.5pt;border-top:none;
  width:13pt'>&nbsp;</td>
  ...
  <td class=xl3035155 width=42 style='border-top:none;width:32pt'>&nbsp;</td>
  <td colspan=3 class=xl2305155 width=214 style='border-right:.5pt solid black;width:160pt'><?php if(isset($employees[0]->emp_second_school)){ echo $employees[0]->emp_second_school; }else{ echo "N/A"; } ?></td>
  <td colspan=3 class=xl3055155 width=196 style='border-right:1.0pt solid black;
  border-left:none;width:148pt'><?php if(isset($employees[0]->emp_second_degree)){ echo $employees[0]->emp_second_degree; }else{ echo "N/A"; } ?></td>
  <td class=xl3135155 width=54 style='border-top:none;width:41pt'><?php if(isset($employees[0]->emp_second_from)){ echo $employees[0]->emp_second_from; }else{ echo "N/A"; } ?></td>
  <td class=xl3095155 width=54 style='border-top:none;width:41pt'><?php if(isset($employees[0]->emp_second_units)){ echo $employees[0]->emp_second_units; }else{ echo "N/A"; } ?></td>
  <td class=xl3145155 width=80 style='border-top:none;width:60pt; font-size:13px;'><?php if(isset($employees[0]->emp_second_units)){ echo $employees[0]->emp_second_units; }else{ echo "N/A"; } ?></td>
  <td class=xl3155155 width=62 style='border-top:none;border-left:none;width:47pt'><?php if(isset($employees[0]->emp_second_yeargrad)){ echo $employees[0]->emp_second_yeargrad; }else{ echo "N/A"; } ?></td>
  <td class=xl3125155 width=196 style='border-top:none;border-left:none;
  width:50pt; word-wrap: break-word;'><?php if(isset($employees[0]->emp_second_acadhonors)){ echo $employees[0]->emp_second_acadhonors; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=34 style='height:25.5pt'>
  <td height=34 class=xl3025155 width=17 style='height:25.5pt;border-top:none;
  width:13pt'>&nbsp;</td>
  ...
  /TRADE COURSE</td>
  <td class=xl3035155 width=42 style='border-top:none;width:32pt'>&nbsp;</td>
  <td colspan=3 class=xl2305155 width=214 style='border-right:.5pt solid black;width:160pt'><?php if(isset($employees[0]->emp_voc_school)){ echo $employees[0]->emp_voc_school; }else{ echo "N/A"; } ?></td>
  <td colspan=3 class=xl3055155 width=196 style='border-right:1.0pt solid black;
  border-left:none;width:148pt'><?php if(isset($employees[0]->emp_voc_degree)){ echo $employees[0]->emp_voc_degree; }else{ echo "N/A"; } ?></td>
  <td class=xl3165155 width=54 style='border-top:none;width:41pt'><?php if(isset($employees[0]->emp_voc_from)){ echo $employees[0]->emp_voc_from; }else{ echo "N/A"; } ?></td>
  <td class=xl3135155 width=54 style='border-top:none;width:41pt'><?php if(isset($employees[0]->emp_voc_to)){ echo $employees[0]->emp_voc_to; }else{ echo "N/A"; } ?></td>
  <td class=xl3105155 width=80 style='border-top:none;width:60pt'><?php if(isset($employees[0]->emp_voc_units)){ echo $employees[0]->emp_voc_units; }else{ echo "N/A"; } ?></td>
  <td class=xl3125155 width=62 style='border-top:none;border-left:none;width:47pt'><?php if(isset($employees[0]->emp_voc_yeargrad)){ echo $employees[0]->emp_voc_yeargrad; }else{ echo "N/A"; } ?></td>
  <td class=xl3125155 width=67 style='border-top:none;width:50pt'><?php if(isset($employees[0]->emp_voc_acadhonors)){ echo $employees[0]->emp_voc_acadhonors; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=34 style='mso-height-source:userset;height:25.5pt'>
  ...
  <td class=xl3035155 width=42 style='border-top:none;width:32pt'>&nbsp;</td>
  <td colspan=3 class=xl2305155 width=214 style='border-right:.5pt solid black;width:160pt'><?php if(isset($employees[0]->emp_college_school)){ echo $employees[0]->emp_college_school; }else{ echo "N/A"; } ?></td>
  <td colspan=3 class=xl3055155 width=196 style='border-right:1.0pt solid black;
  border-left:none;width:148pt'><?php if(isset($employees[0]->emp_college_degree)){ echo $employees[0]->emp_college_degree; }else{ echo "N/A"; } ?></td>
  <td class=xl3135155 width=54 style='border-top:none;width:41pt'><?php if(isset($employees[0]->emp_college_from)){ echo $employees[0]->emp_college_from; }else{ echo "N/A"; } ?></td>
  <td class=xl3095155 width=54 style='border-top:none;width:41pt'><?php if(isset($employees[0]->emp_college_to)){ echo $employees[0]->emp_college_to; }else{ echo "N/A"; } ?></td>
  <td class=xl3105155 width=80 style='border-top:none;width:60pt'><?php if(isset($employees[0]->emp_college_units)){ echo $employees[0]->emp_college_units; }else{ echo "N/A"; } ?></td>
  <td class=xl3115155 width=62 style='border-top:none;border-left:none;
  width:47pt'><?php if(isset($employees[0]->emp_college_yeargrad)){ echo $employees[0]->emp_college_yeargrad; }else{ echo "N/A"; } ?></td>
  <td class=xl3125155 width=67 style='border-top:none;border-left:none;
  width:50pt'><?php if(isset($employees[0]->emp_college_acadhonors)){ echo $employees[0]->emp_college_acadhonors; }else{ echo "N/A"; } ?></td>
 </tr>
 <tr height=34 style='mso-height-source:userset;height:25.5pt'>
  ...
  width:160pt'><?php if(isset($employees[0]->emp_gradstud_school)){ echo $employees[0]->emp_gradstud_school; }else{ echo "N/A"; } ?></td>
  <td colspan=3 class=xl3055155 width=196 style='border-right:1.0pt solid black;
  border-left:none;width:148pt'><?php if(isset($employees[0]->emp_gradstud_degree)){ echo $employees[0]->emp_gradstud_degree; }else{ echo "N/A"; } ?></td>
  <td class=xl3085155 width=54 style='border-top:none;width:41pt'><?php if(isset($employees[0]->emp_gradstud_from)){ echo $employees[0]->emp_gradstud_from; }else{ echo "N/A"; } ?></td>
  <td class=xl3085155 width=54 style='border-top:none;width:41pt'><?php if(isset($employees[0]->emp_gradstud_to)){ echo $employees[0]->emp_gradstud_to; }else{ echo "N/A"; } ?></td>
  <td class=xl3105155 width=80 style='border-top:none;width:60pt'><?php if(isset($employees[0]->emp_gradstud_units)){ echo $employees[0]->emp_gradstud_units; }else{ echo "N/A"; } ?></td>
  <td class=xl3125155 width=62 style='border-top:none;border-left:none;
  width:47pt'><?php if(isset($employees[0]->emp_gradstud_yeargrad)){ echo $employees[0]->emp_gradstud_yeargrad; }else{ echo "N/A"; } ?></td>
  <td class=xl3125155 width=67 style='border-top:none;width:50pt'><?php if($employees[0]->emp_gradstud_acadhonors) { echo $employees[0]->emp_gradstud_acadhonors; }else{ echo "N/A"; } ?></td>
 </tr>
 ...
 <tr height=23 style='height:17.25pt'>
  ...
  border-left:none'><?php echo $employees[0]->emp_current_date; ?></td>
