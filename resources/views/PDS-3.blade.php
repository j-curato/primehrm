...
<table border=0 cellpadding=0 cellspacing=0 width=1034 class=xl6553527828
 ...
 <tr height=37 style='mso-height-source:userset;height:27.75pt'>
  ...
  height:27.75pt;width:339pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVI[0]->vol_org_name) ? $secVI[0]->vol_org_name : ''); ?>" style="height:30px; width:540px; border: none;border-color: transparent;"></td>
  <td class=xl7627828 style='border-top:none;border-left:none'><input type="date" name="pds3[]" value="<?php echo (isset($secVI[0]->vol_from) ? $secVI[0]->vol_from : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td class=xl7627828 style='border-top:none;border-left:none'><input type="date" name="pds3[]" value="<?php echo (isset($secVI[0]->vol_to) ? $secVI[0]->vol_to : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td class=xl7727828 style='border-top:none;border-left:none'><input type="number" name="pds3[]" value="<?php echo (isset($secVI[0]->vol_hours) ? $secVI[0]->vol_hours : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td colspan=4 class=xl14027828 style='border-right:1.0pt solid black;
  border-left:none'><input type="text" name="pds3[]" value="<?php echo (isset($secVI[0]->vol_position) ? $secVI[0]->vol_position : ''); ?>" style="height:30px; width:365px; border: none;border-color: transparent;"></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
 ...
 <tr height=37 style='mso-height-source:userset;height:27.75pt'>
  <td colspan=4 height=37 class=xl14927828 width=450 style='border-right:.5pt solid black;
  height:27.75pt;width:339pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVI[1]->vol_org_name) ? $secVI[1]->vol_org_name : ''); ?>" style="height:30px; width:540px; border: none;border-color: transparent;"></td>
  <td class=xl7627828 style='border-top:none;border-left:none'><input type="date" name="pds3[]" value="<?php echo (isset($secVI[1]->vol_from) ? $secVI[1]->vol_from : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td class=xl7627828 style='border-top:none;border-left:none'><input type="date" name="pds3[]" value="<?php echo (isset($secVI[1]->vol_to) ? $secVI[1]->vol_to : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td class=xl7727828 style='border-top:none;border-left:none'><input type="number" name="pds3[]" value="<?php echo (isset($secVI[1]->vol_hours) ? $secVI[1]->vol_hours : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td colspan=4 class=xl14027828 style='border-right:1.0pt solid black;
  border-left:none'><input type="text" name="pds3[]" value="<?php echo (isset($secVI[1]->vol_position) ? $secVI[1]->vol_position : ''); ?>" style="height:30px; width:365px; border: none;border-color: transparent;"></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
 ...
 <tr height=37 style='mso-height-source:userset;height:27.75pt'>
  <td colspan=4 height=37 class=xl14927828 width=450 style='border-right:.5pt solid black;
  height:27.75pt;width:339pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVI[2]->vol_org_name) ? $secVI[2]->vol_org_name : ''); ?>" style="height:30px; width:540px; border: none;border-color: transparent;"></td>
  <td class=xl7627828 style='border-top:none;border-left:none'><input type="date" name="pds3[]" value="<?php echo (isset($secVI[2]->vol_from) ? $secVI[2]->vol_from : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td class=xl7627828 style='border-top:none;border-left:none'><input type="date" name="pds3[]" value="<?php echo (isset($secVI[2]->vol_to) ? $secVI[2]->vol_to : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td class=xl7727828 style='border-top:none;border-left:none'><input type="number" name="pds3[]" value="<?php echo (isset($secVI[2]->vol_hours) ? $secVI[2]->vol_hours : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td colspan=4 class=xl14027828 style='border-right:1.0pt solid black;
  border-left:none'><input type="text" name="pds3[]" value="<?php echo (isset($secVI[2]->vol_position) ? $secVI[2]->vol_position : ''); ?>" style="height:30px; width:365px; border: none;border-color: transparent;"></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
 ...
 <tr height=37 style='mso-height-source:userset;height:27.75pt'>
  <td colspan=4 height=37 class=xl14927828 width=450 style='border-right:.5pt solid black;
  height:27.75pt;width:339pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVI[3]->vol_org_name) ? $secVI[3]->vol_org_name : ''); ?>" style="height:30px; width:540px; border: none;border-color: transparent;"></td>
  <td class=xl7627828 style='border-top:none;border-left:none'><input type="date" name="pds3[]" value="<?php echo (isset($secVI[3]->vol_from) ? $secVI[3]->vol_from : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td class=xl7627828 style='border-top:none;border-left:none'><input type="date" name="pds3[]" value="<?php echo (isset($secVI[3]->vol_to) ? $secVI[3]->vol_to : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td class=xl7727828 style='border-top:none;border-left:none'><input type="number" name="pds3[]" value="<?php echo (isset($secVI[3]->vol_hours) ? $secVI[3]->vol_hours : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td colspan=4 class=xl14027828 style='border-right:1.0pt solid black;
  border-left:none'><input type="text" name="pds3[]" value="<?php echo (isset($secVI[3]->vol_position) ? $secVI[3]->vol_position : ''); ?>" style="height:30px; width:365px; border: none;border-color: transparent;"></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
 ...
 <tr height=37 style='mso-height-source:userset;height:27.75pt'>
  <td colspan=4 height=37 class=xl14927828 width=450 style='border-right:.5pt solid black;
  height:27.75pt;width:339pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVI[4]->vol_org_name) ? $secVI[4]->vol_org_name : ''); ?>" style="height:30px; width:540px; border: none;border-color: transparent;"></td>
  <td class=xl7627828 style='border-top:none;border-left:none'><input type="date" name="pds3[]" value="<?php echo (isset($secVI[4]->vol_from) ? $secVI[4]->vol_from : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td class=xl7627828 style='border-top:none;border-left:none'><input type="date" name="pds3[]" value="<?php echo (isset($secVI[4]->vol_to) ? $secVI[4]->vol_to : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td class=xl7727828 style='border-top:none;border-left:none'><input type="number" name="pds3[]" value="<?php echo (isset($secVI[4]->vol_hours) ? $secVI[4]->vol_hours : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td colspan=4 class=xl14027828 style='border-right:1.0pt solid black;
  border-left:none'><input type="text" name="pds3[]" value="<?php echo (isset($secVI[4]->vol_position) ? $secVI[4]->vol_position : ''); ?>" style="height:30px; width:365px; border: none;border-color: transparent;"></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
 ...
 <tr height=37 style='mso-height-source:userset;height:27.75pt'>
  <td colspan=4 height=37 class=xl14927828 width=450 style='border-right:.5pt solid black;
  height:27.75pt;width:339pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVI[5]->vol_org_name) ? $secVI[5]->vol_org_name : ''); ?>" style="height:30px; width:540px; border: none;border-color: transparent;"></td>
  <td class=xl7627828 style='border-top:none;border-left:none'><input type="date" name="pds3[]" value="<?php echo (isset($secVI[5]->vol_from) ? $secVI[5]->vol_from : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td class=xl7627828 style='border-top:none;border-left:none'><input type="date" name="pds3[]" value="<?php echo (isset($secVI[5]->vol_to) ? $secVI[5]->vol_to : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td class=xl7727828 style='border-top:none;border-left:none'><input type="number" name="pds3[]" value="<?php echo (isset($secVI[5]->vol_hours) ? $secVI[5]->vol_hours : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td colspan=4 class=xl14027828 style='border-right:1.0pt solid black;
  border-left:none'><input type="text" name="pds3[]" value="<?php echo (isset($secVI[5]->vol_position) ? $secVI[5]->vol_position : ''); ?>" style="height:30px; width:365px; border: none;border-color: transparent;"></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
 ...
 <tr height=37 style='mso-height-source:userset;height:27.75pt'>
  <td colspan=4 height=37 class=xl14927828 width=450 style='border-right:.5pt solid black;
  height:27.75pt;width:339pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVI[6]->vol_org_name) ? $secVI[6]->vol_org_name : ''); ?>" style="height:30px; width:540px; border: none;border-color: transparent;"></td>
  <td class=xl7627828 style='border-top:none;border-left:none'><input type="date" name="pds3[]" value="<?php echo (isset($secVI[6]->vol_from) ? $secVI[6]->vol_from : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td class=xl7627828 style='border-top:none;border-left:none'><input type="date" name="pds3[]" value="<?php echo (isset($secVI[6]->vol_to) ? $secVI[6]->vol_to : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td class=xl7727828 style='border-top:none;border-left:none'><input type="number" name="pds3[]" value="<?php echo (isset($secVI[6]->vol_hours) ? $secVI[6]->vol_hours : ''); ?>" style="height:30px; width:150px; border: none;border-color: transparent;"></td>
  <td colspan=4 class=xl14027828 style='border-right:1.0pt solid black;
  border-left:none'><input type="text" name="pds3[]" value="<?php echo (isset($secVI[6]->vol_position) ? $secVI[6]->vol_position : ''); ?>" style="height:30px; width:365px; border: none;border-color: transparent;"></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
 ...
 <tr height=18 style='height:13.5pt'>
  ...
  height:13.5pt'>(Continue on separate sheet if necessary)</br><button type="button" class="btn btn-success btn-submit-secVI" ><?php echo ((count($secVI) > 0) ? 'Update Section VI' : 'Save Section VI'); ?></button></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
 ...
 <tr height=18 style='height:13.5pt'>
  ...
  height:13.5pt'><a href="{{ url('sheet3/training2').'/'.$user->id }}" style="color:red;" target="_blank">(Continue on separate sheet if necessary)</a></br><button type="button" class="btn btn-success btn-submit-secVII" ><?php echo (count($secVII) > 0 ? 'Update Section VII' : 'Save Section VII' ); ?></button></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
...
<input type="text" name="employee_id"  value="<?php if(isset($empID[0]->employee_no)){ echo $empID[0]->employee_no; }else{ echo 0; } ?>" style="height: 30px;border: none;">
 ...
 <tr height=33 style='mso-height-source:userset;height:24.75pt'>
  ...
  height:24.75pt;width:181pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[0]->other_skill) ? $secVIII[0]->other_skill : ''); ?>" style="height:30px; width:285px; border: none;border-color: transparent;"></td>
  <td colspan=6 class=xl12027828 width=503 style='border-right:.5pt solid black;
  border-left:none;width:377pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[0]->other_recognition) ? $secVIII[0]->other_recognition : ''); ?>" style="height:30px; width:825px; border: none;border-color: transparent;"></td>
  <td colspan=3 class=xl12027828 width=232 style='border-right:1.0pt solid black;
  border-left:none;width:174pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[0]->other_membership) ? $secVIII[0]->other_membership : ''); ?>" style="height:30px; width:275px; border: none;border-color: transparent;"></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
 ...
 <tr height=33 style='mso-height-source:userset;height:24.75pt'>
  <td colspan=2 height=33 class=xl11827828 width=240 style='border-right:.5pt solid black;
  height:24.75pt;width:181pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[1]->other_skill) ? $secVIII[1]->other_skill : ''); ?>" style="height:30px; width:285px; border: none;border-color: transparent;"></td>
  <td colspan=6 class=xl12027828 width=503 style='border-right:.5pt solid black;
  border-left:none;width:377pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[1]->other_recognition) ? $secVIII[1]->other_recognition : ''); ?>" style="height:30px; width:825px; border: none;border-color: transparent;"></td>
  <td colspan=3 class=xl12027828 width=232 style='border-right:1.0pt solid black;
  border-left:none;width:174pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[1]->other_membership) ? $secVIII[1]->other_membership : ''); ?>" style="height:30px; width:275px; border: none;border-color: transparent;"></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
 ...
 <tr height=33 style='mso-height-source:userset;height:24.75pt'>
  <td colspan=2 height=33 class=xl11827828 width=240 style='border-right:.5pt solid black;
  height:24.75pt;width:181pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[2]->other_skill) ? $secVIII[2]->other_skill : ''); ?>" style="height:30px; width:285px; border: none;border-color: transparent;"></td>
  <td colspan=6 class=xl12027828 width=503 style='border-right:.5pt solid black;
  border-left:none;width:377pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[2]->other_recognition) ? $secVIII[2]->other_recognition : ''); ?>" style="height:30px; width:825px; border: none;border-color: transparent;"></td>
  <td colspan=3 class=xl12027828 width=232 style='border-right:1.0pt solid black;
  border-left:none;width:174pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[2]->other_membership) ? $secVIII[2]->other_membership : ''); ?>" style="height:30px; width:275px; border: none;border-color: transparent;"></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
 ...
 <tr height=33 style='mso-height-source:userset;height:24.75pt'>
  <td colspan=2 height=33 class=xl11827828 width=240 style='border-right:.5pt solid black;
  height:24.75pt;width:181pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[3]->other_skill) ? $secVIII[3]->other_skill : ''); ?>" style="height:30px; width:285px; border: none;border-color: transparent;"></td>
  <td colspan=6 class=xl12027828 width=503 style='border-right:.5pt solid black;
  border-left:none;width:377pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[3]->other_recognition) ? $secVIII[3]->other_recognition : ''); ?>" style="height:30px; width:825px; border: none;border-color: transparent;"></td>
  <td colspan=3 class=xl12027828 width=232 style='border-right:1.0pt solid black;
  border-left:none;width:174pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[3]->other_membership) ? $secVIII[3]->other_membership : ''); ?>" style="height:30px; width:275px; border: none;border-color: transparent;"></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
 ...
 <tr height=33 style='mso-height-source:userset;height:24.75pt'>
  <td colspan=2 height=33 class=xl11827828 width=240 style='border-right:.5pt solid black;
  height:24.75pt;width:181pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[4]->other_skill) ? $secVIII[4]->other_skill : ''); ?>" style="height:30px; width:285px; border: none;border-color: transparent;"></td>
  <td colspan=6 class=xl12027828 width=503 style='border-right:.5pt solid black;
  border-left:none;width:377pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[4]->other_recognition) ? $secVIII[4]->other_recognition : ''); ?>" style="height:30px; width:825px; border: none;border-color: transparent;"></td>
  <td colspan=3 class=xl12027828 width=232 style='border-right:1.0pt solid black;
  border-left:none;width:174pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[4]->other_membership) ? $secVIII[4]->other_membership : ''); ?>" style="height:30px; width:275px; border: none;border-color: transparent;"></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
 ...
 <tr height=33 style='mso-height-source:userset;height:24.75pt'>
  <td colspan=2 height=33 class=xl11827828 width=240 style='border-right:.5pt solid black;
  height:24.75pt;width:181pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[5]->other_skill) ? $secVIII[5]->other_skill : ''); ?>" style="height:30px; width:285px; border: none;border-color: transparent;"></td>
  <td colspan=6 class=xl12027828 width=503 style='border-right:.5pt solid black;
  border-left:none;width:377pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[5]->other_recognition) ? $secVIII[5]->other_recognition : ''); ?>" style="height:30px; width:825px; border: none;border-color: transparent;"></td>
  <td colspan=3 class=xl12027828 width=232 style='border-right:1.0pt solid black;
  border-left:none;width:174pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[5]->other_membership) ? $secVIII[5]->other_membership : ''); ?>" style="height:30px; width:275px; border: none;border-color: transparent;"></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
 ...
 <tr height=33 style='mso-height-source:userset;height:24.75pt'>
  <td colspan=2 height=33 class=xl11827828 width=240 style='border-right:.5pt solid black;
  height:24.75pt;width:181pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[6]->other_skill) ? $secVIII[6]->other_skill : ''); ?>" style="height:30px; width:285px; border: none;border-color: transparent;"></td>
  <td colspan=6 class=xl12027828 width=503 style='border-right:.5pt solid black;
  border-left:none;width:377pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[6]->other_recognition) ? $secVIII[6]->other_recognition : ''); ?>" style="height:30px; width:825px; border: none;border-color: transparent;"></td>
  <td colspan=3 class=xl12027828 width=232 style='border-right:1.0pt solid black;
  border-left:none;width:174pt'><input type="text" name="pds3[]" value="<?php echo (isset($secVIII[6]->other_membership) ? $secVIII[6]->other_membership : ''); ?>" style="height:30px; width:275px; border: none;border-color: transparent;"></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
 ...
 <tr height=16 style='mso-height-source:userset;height:12.0pt'>
  ...
  height:12.0pt'>(Continue on separate sheet if necessary)</br><button type="button" class="btn btn-success btn-submit-sec8" ><?php echo (count($secVIII) > 0 ? 'Update Section VIII' : 'Save Section VIII'); ?></button></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
