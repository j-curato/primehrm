...
<table border=0 cellpadding=0 cellspacing=0 width=1034 class=xl6553527828
 ...
 <tr height=18 style='height:13.5pt'>
  ...
  height:13.5pt'><a href='{{ $user->username=='admin' ? url('sheet3/trainingpage3').'/'.(isset($secVII[0]->user_id) ? $secVII[0]->user_id : '#') : url('sheet3/trainingpage3').'/'.$user->id }}' style="color:red;">(Continue on separate sheet if necessary)</br></td>
  <td class=xl6553527828></td>
  <td class=xl6553527828></td>
 </tr>
