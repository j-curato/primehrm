...
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#addDivisionModal" data-whatever="@mdo"><i class="nav-icon icon-plus"></i> Add Division</button>
<button type="button" class="btn btn-primary edit-division" data-toggle="modal" data-target="" data-whatever="@fat"><i class="nav-icon icon-pencil"></i> Edit Division</button>
