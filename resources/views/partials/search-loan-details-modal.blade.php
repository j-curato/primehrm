            ...
            <div class="row">
                <div class="form-group col-sm-12">
                  <label for="recipient-name" class="col-form-label" style="font-weight: 500;">Last Name:</label>
                    <input type="text" name="lname" class="form-control form-control-sm member-tag" id="search_lname" value=""/>
                </div> 
                <div class="form-group col-sm-12">
                  <label for="recipient-name" class="col-form-label" style="font-weight: 500;">First Name:</label>
                  <input type="text" name="fname" class="form-control form-control-sm member-tag" id="search_fname" value="" />
              </div>
              <div class="form-group col-sm-12">
                <label for="recipient-name" class="col-form-label" style="font-weight: 500;">Middle Name:</label>
                <input type="text" name="mname" class="form-control form-control-sm member-tag" id="search_mname" value=""/>
              </div>
                <div class="form-group col-sm-12">
