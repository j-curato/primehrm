...
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#addPositionModal" data-whatever="@mdo"><i class="nav-icon icon-plus"></i> Add Position</button>
