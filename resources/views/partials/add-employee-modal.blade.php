      ...
      <div class="modal-body">
       ...
       {{ csrf_field() }}
          <div class="form-group">
            ...
            <input type="text" name="employee_code" class="form-control form-control-sm" id="add-employee-code" value="" required>
          </div>
          <div class="row">
            <div class="form-group col-sm-4">
              <label for="recipient-name" class="col-form-label" style="font-weight: 500;">First Name:</label>
              <input type="text" name="emp_fname" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
            </div>
            <div class="form-group col-sm-3">
              <label for="recipient-name" class="col-form-label" style="font-weight: 500;">Middle Name:</label>
              <input type="text" name="emp_mname" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
            </div>
            <div class="form-group col-sm-3">
              <label for="recipient-name" class="col-form-label" style="font-weight: 500;">Last Name:</label>
              <input type="text" name="emp_lname" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
            </div>
            <div class="form-group col-sm-2">
              <label for="recipient-name" class="col-form-label" style="font-weight: 500;">Ext:</label>
              <input type="text" name="emp_extension" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="form-group col-sm-4">
              ...
              <input type="date" name="emp_date_of_birth" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
            </div>

            <div class="form-group col-sm-3">
              <label for="recipient-name" class="col-form-label" style="font-weight: 500;">Marital Status:</label>
              <select name="emp_marital_status" class="form-control form-control-sm employee-tag">
             ...
             <div class="form-group col-sm-3">
              ...
              <select name="emp_blood_type" class="form-control form-control-sm employee-tag">
            ...
            <div class="form-group col-sm-2">
              ...
              <select name="emp_sex" class="form-control form-control-sm employee-tag">
          ...
          <div class="row">
            <div class="form-group col-sm-3">
              ...
              <input type="text" name="emp_philhealth_number" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
            </div>
            <div class="form-group col-sm-3">
              <label for="recipient-name" class="col-form-label" style="font-weight: 500;">PAGIBIG #</label>
              <input type="text" name="emp_pagibig_number" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
            </div>
            <div class="form-group col-sm-3">
              <label for="recipient-name" class="col-form-label" style="font-weight: 500;">SSS #</label>
              <input type="text" name="emp_sss_number" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
            </div>
            <div class="form-group col-sm-3">
              <label for="recipient-name" class="col-form-label" style="font-weight: 500;">TIN #</label>
              <input type="text" name="emp_tin_number" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
            </div>
          </div>
          <div class="row">
            <div class="form-group col-sm-3">
              <label for="recipient-name" class="col-form-label" style="font-weight: 500;">Date started:</label>
              <input type="date" name="emp_date_started" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
            </div>
            <div class="form-group col-sm-3">
              <label for="recipient-name" class="col-form-label" style="font-weight: 500;">Date effectivity:</label>
              <input type="date" name="emp_date_effectivity" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
            </div>
            <div class="form-group col-sm-3">
              <label for="recipient-name" class="col-form-label" style="font-weight: 500;">Employment status:</label>
              <select name="emp_employment_status" class="form-control form-control-sm employee-tag">
            ...
            <div class="form-group col-sm-3">
              ...
              <select name="emp_employee_status" class="form-control form-control-sm employee-tag">
          ...
          <div class="row">
            <div class="form-group col-sm-3">
              ...
              <select name="emp_division" required="" class="form-control form-control-sm employee-tag" id="emp_division">
            ...
            <div class="form-group col-sm-3">
              ...
              <select name="emp_unit" required="" class="form-control form-control-sm employee-tag" id="emp_unit">
            ...
            <div class="form-group col-sm-3">
             <label for="recipient-name" class="col-form-label" style="font-weight: 500;">Position:</label>
              <select name="emp_position"  class="form-control form-control-sm employee-tag" required>
             ...
             <div class="form-group col-sm-3">
              ...
              <input type="number" step="0.01" name="emp_salary_rate" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="emp_home_address" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
          </div>
          <div class="row">
            <div class="form-group col-sm-4">
              <label for="recipient-name" class="col-form-label" style="font-weight: 500;">Email address:</label>
              <input type="text" name="emp_email_address" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
            </div>
            <div class="form-group col-sm-4">
              <label for="recipient-name" class="col-form-label" style="font-weight: 500;">Contact #:</label>
              <input type="text" name="emp_contact_number" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
            </div>
            <div class="form-group col-sm-4">
              <label for="recipient-name" class="col-form-label" style="font-weight: 500;">Photo:</label>
              <input type="text" name="emp_photo_url" class="form-control form-control-sm employee-tag" id="recipient-name" value="" required>
            </div>
          </div>
          <address></address>
          <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal" onClick="window.location.reload()" >Close</button>
          <input type="submit" class="btn btn-success btn-submit-employee employee-tag" value="Submit">
          </div>
        </form>
      </div>
