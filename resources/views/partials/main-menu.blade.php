                ...
                <div class="card text-white bg-primary">
                  <div class="card-body pb-0">
                    <button class="btn btn-transparent p-0 float-right" type="button">
                     ...
                     <medium style="color: #000;">Total Amount Granted</medium><br>
                      <strong class="h4" style="color: #000;"><?php echo ($total_amount_granted) ? number_format($total_amount_granted,2) : "0.00"; ?></strong>
                  </div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-info">
                  <div class="card-body pb-0">
                    ...
                    <medium  style="color: #000;">Total Amortizations</medium><br>
                     <strong class="h4" style="color: #000;"><?php echo ($total_amortizations) ? number_format($total_amortizations,2) : "0.00"; ?></strong>
                  </div>
                  <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
                    <canvas class="chart" id="card-chart2" height="70"></canvas>
                  </div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-warning">
                  <div class="card-body pb-0">
                    ...
                    <medium  style="color: #000;">Total Billing Generated</medium><br>
      <strong class="h4" style="color: #000;"><?php echo ($total_bills) ? number_format($total_bills,2) : "0.00"; ?></strong>
                  </div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-danger">
                  <div class="card-body pb-0">
                    ...
                    <medium  style="color: #000;">Total Actual Payments</medium><br>
      <strong class="h4" style="color: #000;"><?php echo ($total_payments) ? number_format($total_payments,2) : "0.00"; ?></strong>
                  </div>
                  <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
