...
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#addUserModal" data-whatever="@mdo"><i class="nav-icon icon-plus"></i> Add User</button>
<button type="button" class="btn btn-primary edit-user" data-toggle="modal" data-target="" data-whatever="@fat"><i class="nav-icon icon-pencil"></i> Edit User</button>
