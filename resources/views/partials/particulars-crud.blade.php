...
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#addParticularModal" data-whatever="@mdo"><i class="nav-icon icon-plus"></i> Add Particular</button>
<button type="button" class="btn btn-primary edit-particular" data-toggle="modal" data-target="" data-whatever="@fat"><i class="nav-icon icon-pencil"></i> Edit Particular</button>
