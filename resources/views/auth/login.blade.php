...
<head>
    ...
    body{
      background-image: url("assets/img/bg-prime.jpg");
    }
...
<center><img class="navbar-brand-full" src="assets/img/DTI_PH-01.png" width="150" height="150"></center>
          ...
          <div class="card-group">
                ...
                <div class="row">
                  <div class="form-group row mb-10">
                        <div class="col-md-12 offset-md-1">
                            <button type="submit" class="btn btn-primary" style="background-color: #1560BD !important;">
                                {{ __('Login') }}
                            </button>
            ...
            <div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%">
              <div class="card-body text-center">
                ...
                <div>
                <br>
                  <h1 style="font-family:Aharoni;">PRIME-HRM</h1>
                  <h2 style="font-family:Aharoni; ">DTI-Caraga</h2>
                </div>
